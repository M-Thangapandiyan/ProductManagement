...
public class ProductServiceImpl implements ProductService {
	 ...
	 * {@inherticDoc}
	 */
	public Product createProduct(String name, int price, Colour colour, Date dateOfManufacture,
			Manufacturer manufactureId, Dealer dealerId) throws ProductManagementException {
		String code = createId();
		Product product = new Product(code, code, 0, null, null);
