...
/**
 * This methods used to validate the date and calculate the yearsDifference
 *
...
public class DateUtil {
	 ...
	 * @throws Exception
	 */
	public static Date getDate(String startDate) throws ProductNotFoundException {
		dateFormat.setLenient(false);
		Date date = null;
		try {
			date = dateFormat.parse(startDate);
		} catch (ParseException productManagementException) {
			throw new ProductNotFoundException("Invalid Date");
		}
		return date;
	}
	...
	/*
	 * public static java.sql.Date getSqlDate(Date date) { return new
